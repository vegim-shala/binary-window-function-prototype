...
int main() {
    ...
    auto [input, input_schema] = read_csv_optimized("D1/input1.csv");
    auto [probe, probe_schema] = read_csv_optimized("D1/probe1.csv");
    ...
    cout << "Output: " << endl;
    write_csv("D1/output.csv", result, new_schema);
